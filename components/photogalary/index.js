    ...
    data: [
      {
        ...
        type: "photo",
        id: 1,
        text: "BJIT 4 digit development team ",
      },
      {
  ...
  useEffect(() => {
    if (inView) {
      const onScroll = () => {
        ...
        } else if (currentPos > 1800 && currentPos < 2080) {
          for (let i = 0; i < childDiv.length; i++) {
            if (i % 2 == 0) {
          ...
          photoList.map((item, index) => (
            ...
            >
              ...
              >
                ...
                />
                <div className={style.hoverBg1}>Gallery</div>
              ...
              >
                <Image
                  ...
                  className={style.photoAlbum}
                />
                <div className={style.hoverBg2}> Gallery</div>
